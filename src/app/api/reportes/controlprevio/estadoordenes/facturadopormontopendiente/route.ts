...
/** Proxy → `GET /api/controlprevio/estadoordenes/facturadopormontopendiente` */
export async function GET(request: NextRequest) {
  ...
  const upstreamUrl = `${base}/api/controlprevio/estadoordenes/facturadopormontopendiente${src.search}`
