...
/** Proxy → `GET /api/controlprevio/stockalmacen/inventarioporcategoria` */
export async function GET(request: NextRequest) {
  ...
  const upstreamUrl = `${base}/api/controlprevio/stockalmacen/inventarioporcategoria${src.search}`
