...
/** Proxy → `GET /api/controlprevio/documentonorelacionados/tablaporrelacionar` */
export async function GET(request: NextRequest) {
  ...
  const upstreamUrl = `${base}/api/controlprevio/documentonorelacionados/tablaporrelacionar${src.search}`
