...
/** Proxy → `GET /api/controlprevio/documentonorelacionados/tablaporliquidar` */
export async function GET(request: NextRequest) {
  ...
  const upstreamUrl = `${base}/api/controlprevio/documentonorelacionados/tablaporliquidar${src.search}`
