...
/** Proxy → `GET /api/controlprevio/documentonorelacionados/tabla` (paginación `?page=`). */
export async function GET(request: NextRequest) {
  ...
  const upstreamUrl = `${base}/api/controlprevio/documentonorelacionados/tabla${src.search}`
