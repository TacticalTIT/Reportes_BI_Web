...
/** Proxy → `GET /api/controlprevio/ingresosnorelacionados/tabla` (paginación `?page=`). */
export async function GET(request: NextRequest) {
  ...
  const upstreamUrl = `${base}/api/controlprevio/ingresosnorelacionados/tabla${src.search}`
