...
/** Proxy → `GET /api/controlprevio/ingresosnorelacionados/top10proveedores` */
export async function GET(request: NextRequest) {
  ...
  const upstreamUrl = `${base}/api/controlprevio/ingresosnorelacionados/top10proveedores${src.search}`
